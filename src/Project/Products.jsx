    ...
    return (
      <>
        <div className="button d-flex justify-content-center mb-5 pb-5 ">
          ...
          <button className="btn btn-outline-dark mx-2" onClick={()=>filterProduct("kids") }>kids</button>
          <button className="btn btn-outline-dark mx-2" onClick={()=>filterProduct("smart phone") }>smart phone</button>
          <button className="btn btn-outline-dark mx-2"onClick={()=>filterProduct("fdfdf") }>fdfdf</button>
          <button className="btn btn-outline-dark mx-2 " onClick={()=>filterProduct("electronics") }>Electronic</button>
        </div>
        {filter.map((product) => {
          return (
            <>
              <div className="col-md-3 mb-4 bg-dark"   >
